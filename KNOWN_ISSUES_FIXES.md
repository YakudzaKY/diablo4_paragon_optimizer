...
- Важно: исправлять надо баги одновременно(без промежуточных тестов), иначе правка первого, может испортить воспроизведение 2 и 3. То есть всё что надо собирать-до исправления баги. Затем фиксить, и делать полный тест, чтоб не воспроизводились похожие кейсы. После чего делать пост-правки если надо
